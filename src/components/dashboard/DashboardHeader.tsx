  ...
  return (
    <header className="h-20 sm:h-24 shrink-0 bg-white dark:bg-[#081640] border-b border-gray-100 dark:border-white/5 flex items-center justify-between px-4 sm:px-6 md:px-10 gap-2">
      ...
      <div className="flex items-center gap-3 sm:gap-6 shrink-0">
        ...
        <div className="w-9 h-9 md:hidden sm:w-10 sm:h-10 font-bold rounded-xl bg-primary-500/10 dark:bg-blue-500/10 flex items-center justify-center text-primary-500 dark:text-blue-400 shrink-0">
            S
          </div>
